...
The follower layouts follow the Figma home widgets at 162×76, 352×76, 162×176 and 352×176 dp. Large-card headings grow or shrink to fit the actual launcher width and height, reserving space for the footer and its clearance. Fitting and drawing use each line’s visible glyph bounds, including accents and descenders, rather than nominal font-size boxes; footer logos stay at 12 dp independently of handle text. One UI compact widgets have pill-shaped surfaces.
